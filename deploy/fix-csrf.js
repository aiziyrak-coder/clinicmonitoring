/**
 * FIX CSRF - 400 xatosini hal qilish
 */
...
// .env faylni yangilash - CSRF qo'shish
...
const COMMANDS = [
  ...
  // 3. Status
  'sleep 3 && systemctl status clinicmonitoring-daphne --no-pager | head -8',
  
  // 4. API test - session endpoint
